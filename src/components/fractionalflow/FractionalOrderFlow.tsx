...
/* The swap toggle: the user's SwitchIcon (src/components/switchicon), set
   inside the control's 40px white disc with its hairline rim. The icon as
   designed — black, 1.8 strokes, its own spacing — a shade larger than its
   16px (scaling it to the old arrows' height spread the two columns and
   read wrong). A tap flips both heads over 0.2s — the icon's paths and
   easing. */
